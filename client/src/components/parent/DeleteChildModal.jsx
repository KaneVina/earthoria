...
export default function DeleteChildModal({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const message =
        err?.response?.data?.message || "Không xoá được, thử lại sau.";
        ...
        {step === "pin" ? (
          <>
            ...
            <p className="pf-confirm-msg">
              Xoá vĩnh viễn hồ sơ của <b>{childName}</b> là hành động nhạy cảm.
              Nhập mã PIN phụ huynh để tiếp tục.
            </p>
            <input
              autoFocus
              type="password"
          ...
          <>
            ...
            <h3 className="pf-confirm-title">
              Xoá vĩnh viễn hồ sơ của {childName}?
            </h3>
            <p className="pf-confirm-msg">
