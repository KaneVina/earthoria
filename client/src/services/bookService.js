...
export const bookService = {
  ...
  addReview: (slug, hashId, data) =>
    api.post(`/books/${slug}/${hashId}/reviews`, data),
  voteReview: (slug, hashId, reviewId, isHelpful) =>
    api.post(`/books/${slug}/${hashId}/reviews/${reviewId}/vote`, {
      isHelpful,
    }),
  ...
  replyToReview: (id, message) =>
    api.post(`/admin/reviews/${id}/reply`, { message }),
