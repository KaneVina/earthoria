  ...
  return (
    ...
    >
      ...
      <div className="lj-row-waypoint">
        ...
        <h4 className="lj-row-waypoint-title">
          {tier.story?.title ?? tier.tagline}
        </h4>
        {tier.story?.desc && (
          <p className="lj-row-waypoint-quote">{tier.story.desc}</p>
        )}
        {(tier.story?.next || tier.story?.conclusion) && (
          <p className="lj-row-waypoint-next">
            {tier.story.next ?? tier.story.conclusion}
          </p>
        )}
      </div>
