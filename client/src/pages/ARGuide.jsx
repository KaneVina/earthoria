...
const FEATURES = [
  {
    icon: Box,
    title: "120+ Mô Hình AR",
    desc: "Mỗi cuốn sách có hơn 120 mô hình 3D siêu thực được nghiên cứu từ dữ liệu khoa học.",
  },
  {
    icon: Mic,
    title: "AI Tutor Thông Minh",
    desc: "Trợ lý AI đóng vai nhà tự nhiên học, trả lời hàng trăm câu hỏi theo cách phù hợp với trẻ.",
  },
  {
    icon: Volume2,
    title: "Âm Thanh 3D Vòm",
    desc: "Công nghệ spatial audio 360° tái hiện âm thanh sinh thái chân thực từng ngách rừng.",
  },
  {
    icon: WifiOff,
    title: "Offline 100%",
    desc: "Sau lần tải đầu, toàn bộ AR hoạt động không cần internet. Chỉ AI Tutor cần kết nối.",
  },
];
...
function buildLionModel(THREE, accentColor) {
  ...
  legPositions.forEach(([x, y, z]) => {
    const leg = new THREE.Mesh(
      new THREE.CylinderGeometry(0.1, 0.09, 0.45, 8),
      fur,
    );
  ...
  const tail = new THREE.Mesh(
    new THREE.CylinderGeometry(0.045, 0.06, 0.65, 8),
    fur,
  );
...
function Lion3D({
    ...
    loadThreeJS().then((THREE) => {
      ...
      function tick() {
        ...
        if (interactive && rotation) {
          ...
          lion.rotation.x = Math.max(
            -0.5,
            Math.min(0.5, rotation.x * (Math.PI / 180)),
          );
  ...
  return (
    <div ref={mountRef} style={{ width: "100%", height, minHeight: "120px" }} />
  );
}
    ...
    async function init() {
      ...
      script.onload = () => {
        ...
        function animate() {
          ...
          if (!reduced) {
            camera.position.x +=
              (mouseRef.current.x * 0.6 - camera.position.x) * 0.04;
            camera.position.y +=
              (-mouseRef.current.y * 0.4 - camera.position.y) * 0.04;
            camera.lookAt(0, 0, 0);
          }
  ...
  useEffect(() => {
    ...
    switch (activeStep) {
      ...
      case 2:
        fade(floatMesh, 0);
        fade(scanPlane, 0.15);
        ring1.material.opacity = 0.6;
        ring2.material.opacity = 0.4;
        break;
      case 3:
        fade(floatMesh, 0.5);
        fade(scanPlane, 0);
        ring1.material.opacity = 0.2;
        ring2.material.opacity = 0.5;
        break;
      case 4:
        fade(floatMesh, 0.4);
        fade(scanPlane, 0);
        ring1.material.opacity = 0.4;
        break;
    }
  }, [activeStep]);
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 30% 50%, rgba(13,51,48,0.7) 0%, transparent 70%)",
            zIndex: 1,
          }}
        />
        <div
          style={{
            ...
            right: 0,
            height: "200px",
            background: "linear-gradient(to top, #050e0a 0%, transparent 100%)",
            zIndex: 2,
          }}
        />
          ...
          <Reveal delay={0.3} y={16}>
            ...
            >
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#5cb84f")
                }
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "#4a9e3f";
                  resetMagnet(e);
                }}
              >
                Bắt Đầu Ngay
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    paddingRight: "40px",
                    borderRight:
                      i < 3 ? "0.5px solid rgba(255,255,255,0.08)" : "none",
        ...
        >
          ...
          <div
            style={{
              ...
              height: "40px",
              background:
                "linear-gradient(to bottom, rgba(74,158,63,0.6), transparent)",
      ...
      <div
        style={{
          ...
          borderBottom: "0.5px solid rgba(74,158,63,0.15)",
          padding: "0 100px",
        }}
      >
        <div
        ...
        >
          ...
          <div
            style={{
              ...
              height: "1px",
              background:
                "linear-gradient(90deg, transparent, rgba(74,158,63,0.4), transparent)",
            }}
          />
          ...
          >
            ...
            <Reveal delay={0.12}>
              ...
              >
                ...
                {idx === 3 && (
                  <ModelDemo color={step.color} modelVisible={modelVisible} />
                )}
                {idx === 4 && (
                  <AIDemo
                    color={step.color}
      ...
      <section
        style={{
          background: "#071210",
          padding: "120px 100px",
          borderTop: "0.5px solid rgba(74,158,63,0.1)",
        }}
      >
      ...
      <section style={{ background: "#050e0a", padding: "120px 100px" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          {[
            [
              "Máy tôi có hỗ trợ không?",
              "Earthoria AR hoạt động trên hầu hết điện thoại từ 2019 trở đi. iPhone SE (2020) trở lên, Android mid-range với 3GB RAM trở lên đều chạy mượt.",
            ],
            [
              "Con tôi dùng được không nếu chưa biết đọc?",
              "Hoàn toàn được! AI Tutor hỗ trợ nhận lệnh giọng nói, và toàn bộ AR hoạt động bằng thao tác chạm trực quan. Trẻ từ 4 tuổi đã có thể dùng độc lập.",
            ],
            [
              "Mất bao lâu để cài đặt?",
              "Tải app mất 2 phút. Tải nội dung AR cho một cuốn sách mất 5–10 phút tuỳ tốc độ mạng. Sau đó dùng offline hoàn toàn.",
            ],
            [
      ...
      <section
        style={{
          ...
          position: "relative",
          overflow: "hidden",
          borderTop: "0.5px solid rgba(74,158,63,0.15)",
        }}
      >
        <div
          style={{
            ...
            width: "600px",
            height: "600px",
            border: "0.5px solid rgba(74,158,63,0.06)",
            borderRadius: "50%",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            width: "400px",
            height: "400px",
            border: "0.5px solid rgba(74,158,63,0.1)",
            borderRadius: "50%",
            pointerEvents: "none",
          }}
        />
        <div style={{ position: "relative", zIndex: 1 }}>
          <Reveal>
            ...
            >
              Hàng ngàn gia đình đã trải nghiệm. Bộ sách đầu tiên chỉ trong 3
              phút là con bé đã có thể khám phá thế giới 3D.
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <div
            ...
            >
              ...
              <Link to="/shop">
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = "#4a9e3f";
                    e.currentTarget.style.color = "#4a9e3f";
                  }}
                  onMouseLeave={(e) => {
    ...
    >
      <div
        style={{
          width: "36px",
          height: "36px",
          border: `0.5px solid ${hover ? "#4a9e3f" : "rgba(74,158,63,0.4)"}`,
          background: hover ? "rgba(74,158,63,0.12)" : "transparent",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
      ...
      <span
        style={{
          fontSize: "12px",
          color: hover ? "#faf8f3" : "rgba(250,248,243,0.45)",
          transition: "color 0.25s",
        }}
      >
        Xem demo trực tiếp 30 giây
      </span>
    </button>
  );
}
  ...
  useEffect(() => {
    ...
    function runScan() {
      ...
      requestAnimationFrame(() => {
        if (!cancelledRef.current) setScanOn(true);
      });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            background: "linear-gradient(160deg, #0f2e20 0%, #1a4a30 100%)",
            borderRadius: "16px",
            padding: "20px",
            minHeight: "280px",
            display: "flex",
        ...
        >
          ...
          >
            {phase === "scan" ? (
              <>
                <Loader2 size={11} className="spin-icon" /> Đang quét trang
                sách...
              </>
            ) : phase === "reveal" ? (
              <>
                <CheckCircle2 size={11} /> Voi châu Phi xuất hiện
              </>
            ) : (
              <>
                <Mic size={11} /> AI Tutor đang trả lời
              </>
            )}
          </div>
          <div
          ...
          >
                ...
                {["tl", "tr", "bl", "br"].map((c) => (
                  <div
                    ...
                    style={{
                      ...
                      borderTop: c.includes("t") ? "2px solid #4a9e3f" : "none",
            ...
            {(phase === "reveal" || phase === "ai") && (
              <div
                style={{ textAlign: "center", animation: "fadeInUp 0.5s ease" }}
              >
                <div
                  style={{
                    width: "64px",
...
function DownloadDemo({ color }) {
  ...
  return (
    <div style={{ width: "320px" }}>
      ...
      >
        {[
          ["app", "Dùng App", Smartphone],
          ["noapp", "Không Cần App", QrCode],
        ].map(([id, label, Icon]) => (
          <button
            key={id}
            onClick={() => setMode(id)}
            style={{
              ...
              color: mode === id ? "#0a0e0c" : "rgba(255,255,255,0.55)",
              border: "none",
              borderRadius: "2px",
              cursor: "pointer",
              fontSize: "12px",
              fontWeight: mode === id ? 500 : 300,
              transition: "all 0.25s",
            }}
          >
      ...
      {mode === "app" ? (
        ...
        >
          ...
          >
            Phiên bản 3.2.1 · 124MB · Miễn phí
          </p>
          <div style={{ display: "flex", gap: "12px" }}>
            {[
              [Apple, "App Store", "iOS 14+"],
              [Bot, "Google Play", "Android 10+"],
            ].map(([Icon, label, sub], i) => (
              <button
                key={i}
                onClick={() => {
                  setPlatform(i);
                  toast.success(`Đang chuyển đến ${label}...`);
                }}
                style={{
                  flex: 1,
                  padding: "16px 12px",
                  background: platform === i ? color : "rgba(255,255,255,0.06)",
                  border: `0.5px solid ${platform === i ? color : "rgba(255,255,255,0.15)"}`,
                  cursor: "pointer",
                  transition: "all 0.3s",
                  color: platform === i ? "#0a0e0c" : "#faf8f3",
                  borderRadius: "2px",
                }}
              >
                <Icon
      ...
      <div
        style={{
          ...
          border: "0.5px solid rgba(74,158,63,0.15)",
          display: "flex",
          alignItems: "center",
          gap: "10px",
        }}
      >
        ...
        >
          Không quảng cáo · Không yêu cầu tài khoản
        </span>
      </div>
    </div>
  );
...
function ScanDemo({ color, scanning, progress, onScan, modelVisible }) {
  ...
  return (
    <div style={{ width: "280px" }}>
      ...
      >
        {[
          ["app", "Quét bằng App", Smartphone],
          ["camera", "Camera / Trình duyệt", Globe],
        ].map(([id, label, Icon]) => (
          <button
            key={id}
            onClick={() => setMode(id)}
            style={{
              ...
              padding: "8px 4px",
              background: mode === id ? color : "transparent",
              color: mode === id ? "#0a0e0c" : "rgba(255,255,255,0.5)",
              border: "none",
              borderRadius: "2px",
              cursor: "pointer",
              fontSize: "10px",
        ...
        >
          ...
          {mode === "camera" && modelVisible ? (
            ...
            >
              ...
              >
                earthoria.ar/book/rung-mua/leo
              </span>
            </div>
          ) : (
            <div
            ...
            >
              {scanning ? (
                <>
                  <Loader2 size={10} className="spin-icon" /> Đang quét...
                </>
              ) : modelVisible ? (
                <>
                  <CheckCircle2 size={10} /> Đã nhận diện
                </>
              ) : (
                "Chế độ AR"
              )}
          ...
          {mode === "camera" && modelVisible && (
            ...
            >
              Mở bằng trình duyệt · Không cần cài App
            </div>
          )}
          {/* Viewfinder */}
          <div
            style={{
              ...
              marginBottom: "12px",
              minHeight: "260px",
              background: modelVisible ? "rgba(74,158,63,0.05)" : "transparent",
              transition: "all 0.5s",
            }}
          >
            {/* Corners */}
            {["tl", "tr", "bl", "br"].map((c) => (
              <div
                ...
                style={{
                  ...
                  animation: scanning
                    ? "cornerSpin 1s ease-in-out infinite"
                    : "none",
                }}
              />
            ))}
            ...
            {modelVisible ? (
              ...
              >
                <div style={{ height: "120px" }}>
                  <Lion3D color={color} height="120px" />
                </div>
                <div
                  style={{
                    fontSize: "11px",
          ...
          <div style={{ position: "relative" }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "50px",
                height: "44px",
                cursor: scanning || modelVisible ? "not-allowed" : "pointer",
                fontSize: "11px",
                color: modelVisible ? color : "#0a0e0c",
                letterSpacing: "0.1em",
                fontFamily: "'Be Vietnam Pro', sans-serif",
                transition: "all 0.3s",
                display: "flex",
                ...
                gap: "8px",
                boxShadow:
                  !scanning && !modelVisible ? `0 4px 24px ${color}66` : "none",
              }}
            >
              {modelVisible ? (
                <>
      ...
      >
        ...
        <div
          style={{
            height: "300px",
            background:
              "radial-gradient(ellipse at center, rgba(74,158,63,0.05) 0%, transparent 70%)",
            position: "relative",
        ...
        >
          <div
            style={{
              width: "100%",
              height: "100%",
              filter: "drop-shadow(0 20px 40px rgba(74,158,63,0.3))",
            }}
          >
            {modelVisible ? (
              <Lion3D
              ...
              <div
                style={{
                  ...
                  animation: !dragging
                    ? "modelFloat 4s ease-in-out infinite"
                    : "none",
                }}
              >
                <Box
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            {[Minus, RotateCcw, Plus].map((Icon, i) => (
              <button
                ...
                onClick={() => {
                  stopInertia();
                  if (i === 0) setZoom((z) => Math.max(0.5, z - 0.2));
                  if (i === 1) {
                    setZoom(1);
                    setRotation({ x: 0, y: 0 });
                  }
                  if (i === 2) setZoom((z) => Math.min(2.5, z + 0.2));
                }}
                style={{
                  width: "28px",
                  height: "28px",
    ...
    <div style={{ width: "340px" }}>
      ...
      >
        ...
        >
          <div style={{ position: "relative", width: "40px", height: "40px" }}>
            ...
            <div
              style={{
                ...
                height: "40px",
                borderRadius: "50%",
                background: `linear-gradient(135deg, ${color}, #5cb84f)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
          ...
          <div>
            <div
              style={{ fontSize: "13px", color: "#faf8f3", fontWeight: 400 }}
            >
              Nhà Tự Nhiên Học AI
            </div>
            <div
        ...
        <div style={{ minHeight: "180px", marginBottom: "20px" }}>
          ...
          >
            Xin chào! Tôi là trợ lý tự nhiên học của Earthoria. Bạn muốn biết
            điều gì về <span style={{ color: color }}>Sư tử châu Phi</span>?
          </div>
          {thinking && (
            <div
              style={{
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "11px",
                      color: speaking ? color : "rgba(255,255,255,0.4)",
                      fontFamily: "'Be Vietnam Pro', sans-serif",
                      padding: 0,
                    }}
                  >
        ...
        <button
          ...
          style={{
            width: "100%",
            height: "52px",
            background: listening ? "rgba(74,158,63,0.2)" : color,
            border: `0.5px solid ${listening ? color : "transparent"}`,
            cursor: listening || typing ? "wait" : "pointer",
            fontSize: "13px",
            color: listening ? color : "#0a0e0c",
            fontFamily: "'Be Vietnam Pro', sans-serif",
            letterSpacing: "0.1em",
            display: "flex",
            alignItems: "center",
            ...
            boxShadow: !listening && !typing ? `0 6px 20px ${color}40` : "none",
          }}
        >
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "52px 48px",
        cursor: "default",
        transition: "transform 0.25s ease-out, background 0.4s",
