...
export default function AboutUs() {
  useEffect(() => {
    ...
    if (rows.length && stickyNum) {
      const valObserver = new IntersectionObserver(
        (entries) => {
          entries.forEach((e) => {
            if (e.isIntersecting) {
  ...
  const handleFormSubmit = (e) => {
    ...
    btn.innerHTML =
      '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="20 6 9 17 4 12"/></svg> Đã gửi thành công!';
      ...
      <section className="logo-section">
        <div className="logo-inner">
          ...
          <div className="logo-analysis-grid">
            ...
            {/* Analysis */}
            <div className="logo-analysis-content reveal reveal-delay-1">
              {[
                {
                  num: "01",
                ...
                <div className="logo-analysis-item" key={i}>
                  ...
                  <div className="logo-analysis-body">
                    ...
                    <p className="logo-analysis-desc">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="tm-grid reveal">
            {[
              ...
              <div className="tm-card" key={i}>
                <div
                  className="tm-bg"
                  style={{ backgroundImage: `url('/${m.img}.png')` }}
                />
                <div className="tm-overlay" />
                <div className="tm-default">
                  <div className="tm-name-d">{m.name}</div>
                  <div className="tm-code-d">{m.code}</div>
                </div>
                <div className="tm-hover">
                  <div className="tm-role">{m.role}</div>
                  <div className="tm-name-h">{m.name}</div>
                  <div className="tm-code-h">
                    {m.code} · FPT University Cần Thơ
                  </div>
                  <div className="tm-divider" />
                  <p className="tm-desc">{m.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="about-values-inner">
          <div className="about-values-layout">
            <div className="about-values-sticky reveal">
              <div className="about-values-sticky-num" id="about-val-num">
                01
              </div>
              <div
                className="section-eyebrow"
              ...
              <h2 className="about-values-sticky-title">
                Nguyên Tắc
                <br />
                <em>Dẫn Đường</em>
              </h2>
              <p className="about-values-sticky-desc">
                Mỗi quyết định thiết kế, mỗi tính năng công nghệ và mỗi trang
                sách đều được định hướng bởi sáu triết lý cốt lõi này.
              </p>
            </div>
            ...
            <div className="about-values-list">
              {[
                ...
                <div
                  className="about-value-row reveal"
                  data-val-num={v.num}
                  key={i}
                >
          ...
          <div className="section-header reveal">
            <div className="section-eyebrow">
              <div
                ...
                style={{ background: "rgba(74,158,63,0.5)" }}
              ></div>
            ...
            <h2 className="section-title" style={{ color: "var(--ivory)" }}>
              Câu Chuyện <em>Earthoria</em>
            </h2>
            <p
              className="section-subtitle"
              style={{ color: "rgba(250,248,243,0.5)" }}
            >
              Từ một ý tưởng trong lớp học đến sản phẩm EdTech đầy tham vọng.
            </p>
          </div>
          ...
          <div className="story-timeline">
            {[
              ...
              },
              {
                ...
                tag: "Expansion roadmap · Đang triển khai",
                delay: "reveal-delay-2",
              },
            ].map((ev, i) => (
        ...
        <div className="advisor-inner">
          <div className="section-header reveal">
            ...
            <p className="section-subtitle">
              ...
              University, mang đến định hướng và kinh nghiệm thực tiễn quý báu.
            </p>
          </div>
          <div className="advisor-grid">
            {[
              {
                type: "Giảng viên hướng dẫn",
                letter: "D",
                name: "Lê Vũ Duy",
