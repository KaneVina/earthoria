    ...
    extraFields: [
      {
        ...
        placeholder: "Đại lý / Phân phối / Co-branding...",
        type: "text",
        required: true,
      },
      {
...
const CONTACT_METHODS = [
  {
    ...
    label: "Điện thoại",
    icon: PhoneCall,
    hint: "083 286 2229 / 0849 324 423",
  },
  {
    id: "zalo",
    label: "Zalo",
    icon: MessageSquare,
    hint: "Zalo: 0849 324 423",
  },
    ...
    <div className="star-rating">
      ...
      {value && (
        <span className="star-label">
          {
            ["", "Rất tệ", "Tạm được", "Bình thường", "Hài lòng", "Xuất sắc"][
              +value
            ]
          }
        </span>
...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      exitTL.to(
        introStatsRef.current,
        { x: "-10vw", scale: 0.85, opacity: 0, ease: "none" },
        0,
      );
      exitTL.to(
        panelIntroRef.current,
        { backgroundColor: "#0a1a14", ease: "none" },
        0,
      );
    ...
    return () => {
      ...
      import("gsap/ScrollTrigger")
        .then(({ ScrollTrigger: ST }) => ST?.getAll().forEach((t) => t.kill()))
        .catch(() => {});
      lenis?.destroy();
    };
  }, []);
  ...
  const handleExtraChange = (e) =>
    setExtraValues((p) => ({ ...p, [e.target.name]: e.target.value }));
    ...
    <>
        ...
        <section className="panel-intro" ref={panelIntroRef}>
          ...
          <div className="intro-content" ref={introContentRef}>
            ...
            <h1 className="intro-headline">
              Hãy cùng <em>kiến tạo</em>
              <br />
              điều tuyệt vời
            </h1>
            <p className="intro-sub">
              Mỗi cuộc hành trình bắt đầu bằng một cuộc trò chuyện. Chúng tôi
              lắng nghe, thấu hiểu và đồng hành cùng bạn.
            </p>
          ...
          <div className="form-section-inner">
            ...
            <div className="contact-info-panel" ref={infoPanelRef}>
              ...
              <div className="contact-cards">
                {CONTACT_CARDS.map(
                  ({ icon: Icon, type, value, sub, href }, i) => (
                    <div
              ...
              <div className="quick-response-badge">
                ...
                <span>
                  Thường phản hồi trong vòng <strong>2 giờ</strong>
                </span>
              </div>
            </div>
            ...
            <div className="contact-form-wrap" ref={formWrapRef}>
              ...
              >
                ...
                <p className="form-header-desc">
                  Điền thông tin bên dưới và chúng tôi sẽ liên hệ trong vòng 24
                  giờ làm việc.
                </p>
              </div>
              ...
              <form className="contact-form" onSubmit={handleSubmit}>
                ...
                {/*  Phương thức liên lạc  */}
                <div
                  className="f-group contact-method-group"
      ...
      <div className={`success-overlay${showSuccess ? " show" : ""}`}>
        ...
        <h2 className="success-title">
          Đã gửi <em>thành công!</em>
        </h2>
        {ticketCode && (
          <div className="success-ticket-code">
            <span className="success-ticket-code-label">
              Mã yêu cầu của bạn
            </span>
        ...
        <p className="success-sub">
          ...
          <strong>{sentMethods.join(", ") || "email"}</strong> trong vòng 24 giờ
          làm việc.
        </p>
        <button
