...
export default function ForgotPassword() {
  ...
  const handleOtpPaste = (e) => {
    ...
    setOtp(next);
    if (pasted.length === 6)
      verifyOtpMutation.mutate({ email: email.trim(), otp: pasted });
                    ...
                    background:
                      step > s.id
                        ...
                        : step === s.id
                          ...
                          : "transparent",
                    borderColor:
                      step >= s.id ? "var(--gold)" : "rgba(255,255,255,0.15)",
                  }}
                >
                  {step > s.id ? (
                    <svg
                ...
                {i < STEPS.length - 1 && (
                  <div
                    style={{
                      ...S.stepConnector,
                      background:
                        step > s.id ? "var(--gold)" : "rgba(255,255,255,0.1)",
                    }}
                  />
                )}
              </div>
            ...
            <div style={S.stepFade} key="step1">
              <div style={S.formHeader}>
                ...
                <h1 style={S.title}>
                  Quên
                  <br />
                  <em style={S.em}>Mật Khẩu</em>?
                </h1>
                <p style={S.subtitle}>
                  Nhập email đã đăng ký, chúng tôi sẽ gửi mã xác thực để giúp
                  bạn lấy lại quyền truy cập.
                </p>
              </div>
              ...
              <form onSubmit={handleSendOtp}>
                <div style={S.fieldGroup}>
                  ...
                  <input
                    ...
                    style={{
                      ...S.input,
                      borderColor: errors.email ? "#b25450" : "var(--border)",
                    }}
                    onFocus={(e) => {
                      if (!errors.email) {
                        e.target.style.borderColor = "var(--gold)";
                        e.target.style.boxShadow =
                          "0 0 0 3px rgba(74,158,63,0.08)";
                      }
                    }}
                    onBlur={(e) => {
                      if (!errors.email) {
              ...
              <p style={S.backLink}>
                Đã nhớ mật khẩu?{" "}
                <Link to="/login" style={S.linkAccent}>
                  Đăng nhập
                </Link>
              </p>
            </div>
            ...
            <div style={S.stepFade} key="step2">
              ...
              <div style={S.resendRow}>
                ...
                <button
                  ...
                  style={{
                    ...S.resendBtn,
                    color: resendTimer > 0 ? "var(--mist)" : "var(--gold)",
            ...
            <div style={S.stepFade} key="step3">
              <div style={S.formHeader}>
                ...
                <h1 style={S.title}>
                  Tạo Mật Khẩu
                  <br />
                  <em style={S.em}>Mới</em>
                </h1>
                <p style={S.subtitle}>
                  Chọn một mật khẩu mạnh mà bạn chưa từng sử dụng ở nơi khác.
                </p>
              </div>
      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...S.input,
            paddingRight: "48px",
            borderColor: error ? "#b25450" : "var(--border)",
          }}
          onFocus={(e) => {
            if (!error) {
              e.target.style.borderColor = "var(--gold)";
              e.target.style.boxShadow = "0 0 0 3px rgba(74,158,63,0.08)";
            }
          }}
          onBlur={(e) => {
            if (!error) {
...
const S = {
  ...
  visualBg: {
    ...
    inset: 0,
    background:
      "radial-gradient(ellipse at 15% 20%, rgba(74,158,63,0.18) 0%, transparent 55%), radial-gradient(ellipse at 85% 80%, rgba(45,122,110,0.22) 0%, transparent 50%), radial-gradient(ellipse at 50% 50%, rgba(13,43,30,0.6) 0%, transparent 70%)",
    pointerEvents: "none",
  },
  visualGrid: {
    position: "absolute",
