    ...
    <>
      ...
      <div className="marquee-section" style={{ marginTop: '80px' }}>
        <div className="marquee-track">
          {[
            book.arModelCount ? `${book.arModelCount}+ Mô Hình AR` : '120+ Mô Hình AR',
            'AI Tutor Thông Minh', 'Âm Thanh 3D Vòm',
            'Cập Nhật Nội Dung 24T', 'Hỗ Trợ VI / EN',
            `Đánh Giá ${avgRating.toFixed(1)} ★`,
          ].concat([
            book.arModelCount ? `${book.arModelCount}+ Mô Hình AR` : '120+ Mô Hình AR',
            'AI Tutor Thông Minh', 'Âm Thanh 3D Vòm',
            'Cập Nhật Nội Dung 24T', 'Hỗ Trợ VI / EN',
      ...
      <div className="ar-section">
        <div className="section-header">
          ...
          <h2 className="section-title reveal">Mở Sách —<br/><em>Thế Giới Hiện Ra</em></h2>
        ...
        <div className="ar-showcase reveal">
          <div className="ar-visual">
            <img src={currentImg} alt="AR Demo" />
          ...
          <div className="ar-features">
            ...
            <div className="ar-feature-list">
              {[
                { num: '01', title: 'Mô hình 3D siêu thực', desc: `${book.arModelCount || '120'}+ mô hình được dựng với độ chi tiết cấp độ bảo tàng — từng vảy, từng lông và màu sắc tái hiện chính xác theo dữ liệu khoa học.` },
                ...
                { num: '03', title: 'Âm thanh không gian 3D', desc: 'Âm thanh sinh thái được xử lý vòm 360° — đắm chìm hoàn toàn trong thế giới của cuốn sách.' },
                { num: '04', title: 'Cập nhật nội dung liên tục', desc: 'Miễn phí cập nhật nội dung mới trong 24 tháng — nội dung mới, thử thách khám phá mới xuất hiện thường xuyên.' },
              ].map(f => (
