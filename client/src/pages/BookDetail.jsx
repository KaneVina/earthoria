...
const RELATED_FALLBACK = [
  {
    ...
    badge: "Mới",
    badgeGold: false,
    name: "Đại Dương Huyền Bí",
    short: "80 loài sinh vật biển sâu trong môi trường AR sống động",
    price: 350000,
    rating: 47,
  },
  {
    ...
    badge: "Đặc biệt",
    badgeGold: true,
    name: "Hành Trình Vũ Trụ",
    short: "Du hành qua 8 hành tinh với mô hình không gian 3D",
    price: 420000,
    rating: 62,
  },
  {
    ...
    badge: "Giới hạn",
    badgeGold: true,
    name: "Khủng Long Trỗi Dậy",
    short: "Hồi sinh 30 loài khủng long theo tỉ lệ thực",
    price: 460000,
    rating: 114,
  },
  {
    ...
    short: "Bóc tách cơ thể người qua mô hình AR độ nét cao",
    price: 390000,
    rating: 88,
  },
];
  ...
  if (isError || !book)
    return (
      ...
      >
        ...
        >
          Sách này có thể đã bị xóa hoặc đường dẫn không đúng.
        </p>
        <Link to="/shop">
      ...
      <div className="product-hero" id="product-hero" ref={heroRef}>
        ...
        <div className="gallery-wrap reveal-left">
          <div className="gallery-main">
            <img
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = imgFading
                  ? "scale(1.03)"
                  : "scale(1)";
              }}
            />
            ...
            <button
              className="gallery-ar-btn"
              onClick={() =>
                toast.success("Tính năng AR Demo đang được phát triển!")
              }
            >
        ...
        <div className="product-info reveal-right">
          ...
          <div className="product-tags">
            ...
            {book.has3DAudio && (
              <span className="product-tag">Âm Thanh 3D</span>
            )}
            {book.languages?.map((lang) => (
              <span key={lang} className="product-tag">
                {lang}
              </span>
            ))}
            {book.ageRange && (
          ...
          <div className="price-block">
            <div>
              ...
              <div className="price-main">
                {hasDiscount ? (
                  <CountdownPrice from={originalPrice} to={discountedPrice} />
                ) : (
            ...
            {hasDiscount && (
              <span className="price-save">
                Tiết kiệm {formatPrice(originalPrice - discountedPrice)} · −
                {discountPct}%
              </span>
            )}
          </div>
          ...
          <div className="trust-micro">
            {[
              ...
              [
                ...
                "Thanh toán an toàn · Mã hoá SSL 256-bit",
              ],
            ].map(([icon, text], i) => (
              <div key={i} className="trust-micro-item">
                {icon} {text}
              </div>
            ))}
          </div>
        ...
        {activeTab === "details" && (
          <div className="tab-panel active">
            <div className="details-grid">
              <div>
                <h3 className="details-col-title">
                  Thông Số <em>Kỹ Thuật</em>
                </h3>
  ...
  return (
    <div className={`product-card reveal ${delay || ""}`}>
      <div className="product-img-wrap">
        ...
        <span className={`product-card-badge${badgeGold ? " gold" : ""}`}>
          {badge}
        </span>
      </div>
