...
import { fmtDurationVi, fmtNumberVi } from "../../components/knowledgeGarden/gardenHelpers";
  ...
  return (
    <div className="gp-page">
      <header className="gp-topbar">
        <button type="button" className="gp-back-btn" onClick={goBack} aria-label="Quay lại">
          <ArrowLeft size={20} />
        </button>
        <span className="gp-topbar-title">Vườn Tri Thức</span>
      ...
      <div className="gp-content">
        ...
        {status === "error" && (
          <div className="gp-error">
            ...
            <button type="button" className="kg-cta-btn" onClick={() => fetchGarden()}>
              Thử lại
            </button>
          </div>
        )}
        ...
        {status === "ok" && data && (
          <section className="kg-root gp-root">
            ...
            {(() => {
              ...
              const isFreshStart =
                trees.length === 1 && activeTree.knowledgeXp === 0 && activeTree.status === "ALIVE";
                  ...
                  <div className="kg-empty">
                    ...
                    <div className="kg-empty-pot" aria-hidden="true">
                      <svg viewBox="0 0 120 120" className="kg-empty-seed-svg">
                        ...
                        <path className="kg-empty-pot-body" d="M34 62 L86 62 L78 100 Q60 106 42 100 Z" />
                        ...
                        >
                          <path className="kg-empty-sprout-stem" d="M60 62 C60 48 60 42 60 34" />
                    ...
                    <button type="button" className="kg-cta-btn kg-cta-btn--lg" onClick={goToShelf}>
                      <BookOpen size={16} />
                      Đọc sách ngay
                    </button>
                ...
                <>
                  ...
                  <div className="kg-current-card">
                    ...
                    <div className="kg-current-info">
                      ...
                      <button type="button" className="kg-cta-btn kg-cta-btn--sm" onClick={goToShelf}>
