...
export default function ProductFormFields({
  ...
  const setVariants = (updater) =>
    setForm((prev) => ({
      ...prev,
      variants:
        typeof updater === "function" ? updater(prev.variants) : updater,
    }));
  ...
  const aiDraftMutation = useMutation({
    mutationFn: () =>
      api
        .post(`/admin/products/${productId}/ai-draft-content`)
        .then((r) => r.data),
    onSuccess: (res) => {
    ...
    onError: (e) =>
      toast.error(
        e.response?.data?.message || "AI soạn nháp thất bại, thử lại sau nhé",
      ),
  });
  ...
  return (
    <div className="a-form-grid">
      ...
      <div className="a-form-group span-2">
        ...
        />
        <span style={{ fontSize: 10, color: "rgba(13,51,48,0.4)" }}>
          Nhiều chủ đề cách nhau bằng dấu phẩy
        </span>
      </div>
