    ...
    <>
      ...
      <div className="a-chart-card" style={{ marginBottom: 20 }}>
        <div className="a-chart-card-header">
          ...
          <p className="a-chart-sub">
            Thông tin chung và kênh liên hệ hiển thị ngoài trang web
          </p>
        </div>
      ...
      <div className="a-chart-card" style={{ marginBottom: 20 }}>
        <div className="a-chart-card-header">
          ...
          <p className="a-chart-sub">
            Dải thông báo hiển thị trên toàn trang, ví dụ khuyến mãi hoặc thông
            báo ngắn
          </p>
        </div>
        ...
        <div className="a-fields-grid" style={{ marginTop: 12 }}>
          <Field
            ...
            placeholder="VD: Miễn phí vận chuyển đơn từ 500K"
          />
          <Field
            label="Liên kết khi bấm vào (tuỳ chọn)"
            value={form.bannerLink}
            onChange={set("bannerLink")}
            placeholder="/shop"
          />
        </div>
      </div>
      ...
      <div className="a-chart-card" style={{ marginBottom: 20 }}>
        <div className="a-chart-card-header">
          ...
          <p className="a-chart-sub">
            Bật/tắt nhanh các tính năng cho toàn hệ thống
          </p>
        </div>
      ...
      <div className="a-chart-card" style={{ marginBottom: 20 }}>
        <div className="a-chart-card-header">
          ...
          <p className="a-chart-sub">
            Ngưỡng và giới hạn áp dụng cho toàn bộ đơn hàng
          </p>
        </div>
      ...
      {error && (
        <div className="a-field-error" style={{ marginBottom: 12 }}>
          {error}
        </div>
      )}
