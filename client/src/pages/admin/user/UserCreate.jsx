...
const ROLE_OPTIONS = {
  ...
  STAFF: [{ value: "DEALER", label: "Dealer" }],
};
...
export default function UserCreate() {
  ...
  const [form, setForm] = useState({
    name: "",
    email: "",
    role: roleOptions.length === 1 ? roleOptions[0].value : "",
    gender: "",
    phone: "",
  });
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: 560 }}>
        <div className="a-table-card" style={{ padding: 28 }}>
          ...
          >
            ...
            >
              Mã ETR và mật khẩu tạm thời sẽ được hệ thống tự sinh ngẫu nhiên và
              gửi qua email cho người dùng, kèm yêu cầu đổi mật khẩu ngay khi
              đăng nhập lần đầu.
            </p>
          </div>
        </div>
