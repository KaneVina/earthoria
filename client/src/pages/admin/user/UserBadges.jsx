/* ─ TierBadge — hiển thị hạng thành viên (I, II, III...) đồng bộ với hệ thống loyalty ─
   Dùng chung giữa Users.jsx (cột "Hạng" trong danh sách, không hình) và UserDetailDrawer.jsx (chi tiết, có hình). */
export function TierBadge({ tier, size = 'sm', showImage = true }) {
