...
export default function Coupons() {
  ...
  const createMutation = useMutation({
    ...
    onError: (e) =>
      toast.error(e.response?.data?.message || "Tạo mã thất bại!"),
  });
      ...
      <div className="a-voucher-grid">
        {isLoading ? (
          ...
          filteredCoupons.map((coupon) => {
            ...
            if (!coupon.isActive)
              statusBadge = { cls: "danger", label: "Đã tắt" };
            else if (isExpired)
              statusBadge = { cls: "neutral", label: "Hết hạn" };
            else if (isFull)
              statusBadge = { cls: "warning", label: "Hết lượt" };
                ...
                <div className="a-voucher-body">
                  <div className="a-voucher-head">
                    <div className="a-voucher-code-row">
                      <span className="a-code-badge" title={coupon.code}>
                        {coupon.code}
                      </span>
                      <button
                    ...
                    <span className={`a-badge ${statusBadge.cls}`}>
                      {statusBadge.label}
                    </span>
                  </div>
                  ...
                  <div className="a-voucher-meta">
                    <div className="a-voucher-meta-item">
                      <span className="a-voucher-meta-label">
                        Đơn tối thiểu
                      </span>
                  ...
                  <div className="a-voucher-footer">
                    <span
                      className={`a-voucher-expiry ${isExpired ? "expired" : isExpiringSoon ? "soon" : ""}`}
                    >
        ...
        >
          <div className="a-modal" style={{ maxWidth: 400 }}>
            ...
            >
              ...
              <h3 className="a-modal-title" style={{ marginBottom: 8 }}>
                Xóa mã giảm giá?
              </h3>
