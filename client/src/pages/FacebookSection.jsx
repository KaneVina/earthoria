...
const MOCK_POSTS = [
  ...
  },
  {
    id: "4",
    message:
      "Cảm ơn cộng đồng Earthoria đã đồng hành! Mỗi lựa chọn của bạn là một bước tiến cho một hành tinh tốt đẹp hơn 🌍",
    permalink_url: "https://www.facebook.com/Earthoriavn",
    full_picture: null,
    created_time: "2025-06-12T09:15:00Z",
  },
  {
    id: "5",
    message:
      "Hành trình xanh bắt đầu từ những điều nhỏ nhất. Chúng tôi cam kết mang đến những sản phẩm không chỉ đẹp mà còn có trách nhiệm với môi trường 🌱",
    permalink_url: "https://www.facebook.com/Earthoriavn",
    full_picture: null,
    created_time: "2025-06-10T07:00:00Z",
  },
  {
    id: "6",
    message:
  ...
  return (
    <a
      ...
      style={{
        ...
        transition:
          "transform .35s cubic-bezier(.16,1,.3,1), box-shadow .35s, border-color .3s",
        cursor: "pointer",
      }}
    >
      {/*  IMAGE  */}
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(10,30,20,.5) 0%, transparent 55%)",
            pointerEvents: "none",
          }}
        />
        {/* date tag */}
      ...
      >
        ...
        >
          {msg || (
            <em style={{ color: T.textMuted }}>Bài viết không có nội dung.</em>
          )}
        </p>
      ...
      <div style={{ maxWidth: 1360, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Earthoria trên{" "}
              <em style={{ fontStyle: "italic", color: T.fb }}>
                nền tảng Facebook
              </em>
            </h2>
          </div>
          <a
            ...
            style={{
              ...
              color: T.fb,
              textDecoration: "none",
              border: ".5px solid rgba(24,119,242,.35)",
              padding: "7px 14px",
              transition: "background .25s",
            }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.background = "rgba(24,119,242,.07)")
            }
            onMouseLeave={(e) =>
