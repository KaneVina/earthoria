...
import { ArrowLeft, Home, Compass, BookOpen, Newspaper, Mail } from 'lucide-react'
...
function LostCompass() {
  return (
    ...
    >
      ...
      {/* N / E / S / W */}
      <text x="66" y="20" textAnchor="middle" fontSize="8" fill="var(--forest)" fontFamily="Playfair Display, serif" opacity="0.7">B</text>
      <text x="66" y="102" textAnchor="middle" fontSize="8" fill="var(--text-muted)" fontFamily="Playfair Display, serif" opacity="0.5">N</text>
      ...
      >
        <polygon points="66,26 71,56 66,64 61,56" fill="var(--forest)" opacity="0.85" />
        <polygon points="66,86 71,56 66,50 61,56" fill="var(--text-muted)" opacity="0.5" />
      </motion.g>
      ...
      >
        <path d="M104 100c0 6-6 12-6 12s-6-6-6-12a6 6 0 1112 0z" fill="var(--forest)" opacity="0.18" />
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          fontSize: '12px', color: 'var(--text-muted)', marginBottom: '28px',
      ...
      >
        ...
        >
          Trang bạn tìm có thể đã đổi tên, được di chuyển, hoặc chưa từng tồn tại.
        </p>
        <p
          style={{
            fontSize: '11px',
      ...
      <div style={{ width: '32px', height: '1px', background: 'var(--border)', marginBottom: '32px' }} />
      ...
      <motion.div
        ...
        style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '44px' }}
      >
