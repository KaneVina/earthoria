...
const globalCSS = `
  ...
  .bp-newsrole { font-size:8.5px; letter-spacing:.14em; text-transform:uppercase; color:${T.gold}; background:${T.goldPale}; border:.5px solid ${T.borderGold}; padding:2px 8px; }
  ...
  .bp-pagebtn.act { background:${T.forest}; color:${T.ivory}; border-color:${T.forest}; }
  .bp-pagebtn:disabled { opacity:.35; cursor:not-allowed; }
`;
...
function Hero() {
  const recent = [
    {
      img: "https://images.unsplash.com/photo-1501004318641-b39e6451bec6?w=300&q=80&auto=format&fit=crop",
      cat: "Nông nghiệp Xanh",
      title:
        "Phương pháp canh tác thuận tự nhiên đang thay đổi vùng cao nguyên",
      author: "Trần Hà Linh",
      time: "8 phút",
      date: "14/6",
    },
    ...
    >
      ...
      >
        <img
          ...
          src="https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?w=1200&q=80&auto=format&fit=crop"
          alt="Rừng"
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top,rgba(5,20,15,.97) 0%,rgba(5,20,15,.6) 40%,rgba(5,20,15,.12) 76%,transparent 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            <span
              style={{
                ...
                textTransform: "uppercase",
                color: T.gold,
                background: "rgba(61,145,50,.14)",
                border: "0.5px solid rgba(61,145,50,.32)",
                padding: "5px 13px",
              }}
            >
              Thiên nhiên & Bảo tồn
          ...
          >
            Hành trình tìm lại{" "}
            <em style={{ fontStyle: "italic", color: T.gold }}>tiếng thở</em>
            <br />
            của những cánh rừng nguyên sinh
          </h1>
          <p
            style={{
              fontSize: 13,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
              <div
                style={{
                  width: 32,
                  height: 32,
                  border: ".5px solid rgba(61,145,50,.44)",
                  background: "rgba(61,145,50,.13)",
                  display: "flex",
                  alignItems: "center",
              ...
              <div>
                <div style={{ fontSize: 11.5, color: "rgba(250,247,241,.75)" }}>
                  Nguyễn Minh Thư
                </div>
                <div
                  style={{
      ...
      <div
        style={{
          ...
          background: T.ivory,
          borderLeft: `.5px solid ${T.borderGold}`,
        }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              The{" "}
              <em style={{ fontStyle: "italic", color: T.gold }}>Earthoria</em>
              <br />
              Journal
            </div>
          </div>
          ...
          {recent.map((a, i) => (
            <a key={i} href="#" className="bp-rrow">
              <div
                style={{
                  overflow: "hidden",
                  borderRight: `.5px solid ${T.border}`,
                }}
              >
        ...
        >
          <a href="#" className="bp-va">
            Xem tất cả bài viết <Arr size={13} />
          </a>
          ...
          {cats.map((c, i) => (
            ...
            >
              ...
              <span
                style={{
                  fontSize: 8.5,
                  background: "rgba(61,145,50,.18)",
                  border: ".5px solid rgba(61,145,50,.28)",
                  padding: "1px 6px",
                  color: T.gold,
                }}
              >
...
function Articles() {
  ...
  const bigs = [
    {
      img: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=700&q=80&auto=format&fit=crop",
      badge: "Trending",
      bGold: true,
      cat: "Nông nghiệp Xanh",
      title:
    ...
    {
      img: "https://images.unsplash.com/photo-1497250681960-ef046c08a56e?w=700&q=80&auto=format&fit=crop",
      badge: "Khoa học",
      bGold: false,
      cat: "Khoa học & Đất",
      title:
    ...
    {
      img: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=700&q=80&auto=format&fit=crop",
      badge: "Mới",
      bGold: false,
      cat: "Cộng đồng",
      title:
  ...
  const picks = [
    {
      title: "Hạt giống bản địa và cuộc chiến chống lai giống đại trà",
  ...
  const minis = [
    ...
    {
      img: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=200&q=80&auto=format&fit=crop",
      cat: "Cộng đồng",
      title: "Chợ nông sản hữu cơ cuối tuần tại Hà Nội",
      date: "22/5 · 3 phút",
    },
  ];
      ...
      <div className="bp-abig-img">
        ...
        <div
          style={{
            ...
            textTransform: "uppercase",
            color: T.ivory,
            background: a.bGold ? T.gold : T.forest,
            padding: "3px 11px",
          }}
        >
          {a.badge}
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 11, color: T.forest, fontWeight: 400 }}>
                {a.name}
              </div>
              <div style={{ fontSize: 9.5, color: T.textMuted, marginTop: 1 }}>
                {a.date} · {a.read}
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <br />
              mỗi{" "}
              <em style={{ fontStyle: "italic", color: T.gold }}>thứ Sáu</em>
            </div>
            <p
              style={{
                fontSize: 11.5,
                lineHeight: 1.72,
                color: "rgba(250,247,241,.44)",
                fontWeight: 300,
                marginBottom: 18,
              }}
            >
            ...
            <div style={{ padding: "14px 18px" }}>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {allTags.map((t) => (
                  <button
                    key={t}
                    className={`bp-tag${tags.includes(t) ? " act" : ""}`}
                    onClick={() => tog(t)}
                  >
                    {t}
                  </button>
      ...
      <div style={{ maxWidth: 1360, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Khám phá theo{" "}
              <em style={{ fontStyle: "italic", color: T.gold }}>chủ đề</em>
            </h2>
          </div>
          <a href="#" className="bp-va">
            Xem tất cả <Arr size={13} />
          </a>
        </div>
        <div
          className="bp-ed-grid er"
...
function CTA() {
  ...
  const tog = (t) =>
    setInts((p) => (p.includes(t) ? p.filter((x) => x !== t) : [...p, t]));
  const perks = [
    ...
    >
      ...
      >
        <div className="er">
          ...
          >
            Hàng tuần, chúng tôi tuyển chọn những câu chuyện hay nhất về thiên
            nhiên, nông nghiệp và lối sống bền vững.
          </p>
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          >
            Hơn 12,000 người đọc đã tham gia cộng đồng.
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {all.map((t) => (
                  <button
                    key={t}
                    className={`bp-int${ints.includes(t) ? " act" : ""}`}
                    onClick={() => tog(t)}
                  >
                    {t}
                  </button>
            ...
            >
              Bảo mật theo{" "}
              <a href="#" style={{ color: T.gold, textDecoration: "none" }}>
                Chính sách riêng tư
              </a>{" "}
              · Không spam
            </div>
...
function formatFileBytes(bytes) {
  if (bytes === null || bytes === undefined) return "Không rõ dung lượng";
  if (bytes < 1024) return `${bytes} B`;
  if (bytes < 1024 * 1024) return `${(bytes / 1024).toFixed(1)} KB`;
  return `${(bytes / (1024 * 1024)).toFixed(1)} MB`;
}

function MiniPagination({ page, totalPages, onChange }) {
  ...
  return (
    ...
    >
      ...
      {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
        <button
          key={p}
          className={`bp-pagebtn${p === page ? " act" : ""}`}
          onClick={() => onChange(p)}
        >
          {p}
        </button>
...
function PublicFiles() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    newsService
      .getPublicFiles({ page, limit: LIMIT })
      .then((res) => {
        if (!alive) return;
        const d = res.data.data;
        setFiles(d.files || []);
          ...
          {files.map((f) => (
            ...
            >
              ...
              <div className="bp-fileinfo">
                ...
                <div>
                  <b>Người đăng:</b> {f.uploader?.name} (
                  {ROLE_LABEL_VN[f.uploader?.role] || f.uploader?.role})
                </div>
                <div>
                  <b>Ngày đăng:</b> {formatVNDate(f.createdAt)}
                </div>
                <div>
