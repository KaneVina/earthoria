        ...
        <div>
          ...
          >
            ...
            >
              ...
              Nhập <strong style={{ color: "var(--ivory)" }}>EARTH15</strong> để
              giảm 15%
            </span>
          ...
          {items.map((item) => (
            ...
            >
                ...
                >
                  <img
                    src={
                      ...
                      "https://via.placeholder.com/88x112"
                    }
                    alt={item.book.title}
                    style={{
                      width: "100%",
              ...
              <div style={{ textAlign: "right" }}>
                ...
                >
                  {formatPrice(
                    (item.book.salePrice || item.book.price) * item.quantity,
                  )}
                </div>
                {item.book.salePrice && (
                  <div
              ...
              {[
                ...
                ...(couponApplied
                  ? [
                      {
                        label: "Mã EARTH15 (−15%)",
                        val: `-${formatPrice(couponDiscount)}`,
                        red: true,
                      },
                    ]
                  : []),
