...
const POLICIES = [
  ...
  },
  {
    ...
    desc: "Các phương thức thanh toán được chấp nhận, bảo mật giao dịch, thời hạn phiên thanh toán và cách xử lý khi thanh toán thất bại hoặc cần hoàn tiền.",
    version: "v1.0",
    updated: "14/09/2026",
    highlights: [
      "COD, VNPay, MoMo, Chuyển khoản QR",
      "Không lưu dữ liệu thẻ, chuẩn PCI DSS",
      "Phiên thanh toán tự huỷ sau 30 phút",
    ],
    to: "/legal/payment",
