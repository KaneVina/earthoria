      ...
      <div className="auth-visual">
        ...
        <div className="auth-visual-content">
          ...
          <h2 className="auth-visual-headline">
            Tiếp tục<br/>hành trình<br/><em>khám phá</em>
          </h2>
          <div className="auth-visual-perks">
            {[
              { text: <><strong>Thư viện sách AR</strong> — hơn 2.400 đầu sách tương tác.</> },
              { text: <><strong>Học không giới hạn</strong> — đồng bộ trên mọi thiết bị.</> },
              { text: <><strong>Cộng đồng 180.000+</strong> — chia sẻ và khám phá cùng nhau.</> },
            ].map((p, i) => (
        ...
        <div className="auth-visual-quote">
          <p className="auth-quote-text">Lời khuyên của tôi là hãy đọc mọi thứ trong tầm mắt và hãy bắt đầu từ khi còn rất trẻ.</p>
      ...
      <div className="auth-form-panel">
        <div className="auth-form-wrap">
          <div className="auth-form-header">
            ...
            <h1 className="auth-form-title">Xin chào,<br/><em>người bạn đọc</em></h1>
            <p className="auth-form-subtitle">Nhập thông tin để tiếp tục khám phá thư viện của bạn.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '16px 0 28px' }}>
              <label className="auth-check-group">
                ...
                <span style={{ fontSize: '12px', color: 'var(--text-muted)', fontWeight: 300 }}>Ghi nhớ đăng nhập</span>
              </label>
              <a href="#" style={{ fontSize: '12px', color: 'var(--gold)', textDecoration: 'none' }}>Quên mật khẩu?</a>
            </div>
