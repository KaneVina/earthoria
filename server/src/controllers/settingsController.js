...
const getPublicSettings = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không tải được cấu hình trang web" });
  }
};
...
const getAdminSettings = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không tải được cài đặt hệ thống" });
  }
};
...
const updateAdminSettings = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Cập nhật cài đặt thất bại" });
  }
};
